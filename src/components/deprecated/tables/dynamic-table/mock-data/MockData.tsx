export const ProductService = {
  ...
  async getProductsWithSlice(page: number, limit: number) {
    await this.timeout(1000);
    const totalData = this.getProductsData();
    const data = totalData.slice(
      limit * page,
      limit * (page + 1) >= totalData.length ? totalData.length : limit * (page + 1),
    );
    return { data, totalRecords: totalData.length, page };
  },
